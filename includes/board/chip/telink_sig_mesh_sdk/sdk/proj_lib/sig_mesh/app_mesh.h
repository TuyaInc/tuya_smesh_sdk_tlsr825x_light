...
#if(CONFIG_LOG_ON && TELINK_LOG_EN)
#define LOG_FW_FUNC_EN  1
#else
#define LOG_FW_FUNC_EN  0
#endif

//#define LOG_FW_FUNC_EN  (CONFIG_LOG_ON && TELINK_LOG_EN) // (__LIB_EN__ || HCI_LOG_FW_EN) // if use __LIB_EN__, it will be different between src and release version.
