...
#ifndef __TY_LIGHT_SAVE_SOC_FLASH_H__
#define __TY_LIGHT_SAVE_SOC_FLASH_H__
 ...
 */
OPERATE_LIGHT ty_light_save_soc_flash_write(IN u32 uiAddr, IN u8 *pData, IN u16 usLen);
 ...
 */
OPERATE_LIGHT ty_light_save_soc_flash_read(IN u32 uiAddr, IN u16 usLen, OUT u8 *pData);
 ...
 * @retval: OPERATE_RET
 */
OPERATE_LIGHT ty_light_save_soc_flash_erase_sector(u32 addr);
